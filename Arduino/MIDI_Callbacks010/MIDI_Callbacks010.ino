...
unsigned msgDATA[][2]={{0,0}, {1,0}, {2,0}, {3,0},          // Note 24 - 27 [Dancer 1]
                       {0,0},                               // Note 28 (not in used)
                       
                       {0,0}, {1,0}, {2,0}, {3,0},          // Note 29 - 32 [Dancer 2]
                       
                       {0,0}, {1,0}, {2,0}, {3,0},          // Note 33 - 36 [Dancer 3]
                       {0,0},                               // Note 37 (not in used)
                        
                       {0,0}, {1,0}, {2,0}, {3,0},          // Note 38 - 41 [Dancer 3]
                       {0,0},                               // Note 42 (not in used)                     

                       {0,0}, {1,0}, {2,0}, {3,0}           // Note 43 - 46 [Dancer 3]
                      } 
...
void HandleNoteOn(byte channel, byte pitch, byte velocity) {
  ...
  if ((pitch >= STMAN01_NOTE) && (pitch <= STMAN_LASTNOTE))
  {
      ...
      msgDATA = msgDATA[msgIndex] | elStatus;
      msgReady=1;
      break;
  }
