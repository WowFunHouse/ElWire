...
void dancerSysShowID()
{
	unsigned char n;
	unsigned int  t;

	t=100;									// Flashing gap = 100ms
...
void main(void)
{
	...
	dancerSysShowID();								// Show the Dancer ID
